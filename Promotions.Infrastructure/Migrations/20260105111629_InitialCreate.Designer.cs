...
namespace Promotions.Infrastructure.Migrations
{
    ...
    [Migration("20260105111629_InitialCreate")]
            ...
            modelBuilder.Entity("Promotions.Domain.PromoActions.PromoAction", b =>
                {
                    ...
                    b.Property<string>("ContractorCodDiv")
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("ContractorCodHier")
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("ContractorCodNode")
                        .HasColumnType("nvarchar(30)");
                    ...
                    b.HasIndex("ContractorCodHier", "ContractorCodDiv", "ContractorCodNode", "ContractorIdLevel", "ContractorDteStart");
            ...
            modelBuilder.Entity("Promotions.Domain.PromoActions.PromoAction", b =>
                {
                    b.HasOne("Promotions.Domain.CustomerRelations.CustomerRelation", "Contractor")
                        .WithMany()
                        .HasForeignKey("ContractorCodHier", "ContractorCodDiv", "ContractorCodNode", "ContractorIdLevel", "ContractorDteStart");
